...
def classify_sentiment_with_distilroberta(
    ...
    """Use Llama 3 to classify feedback sentiment for DistilroBERTa results."""
...
"""
    ...
    try:
        ...
        if attempt < 3:
            ...
            return classify_sentiment_with_distilroberta(feedback, topic, attempt + 1)
        return {
            "sentiment": "neutral",
            "score": 2,
...
def main() -> None:
    ...
    json_path = BASE_DIR / "results" / "DistilroBERTa" / "DISTILROBERTA_OUTPUT.json"
